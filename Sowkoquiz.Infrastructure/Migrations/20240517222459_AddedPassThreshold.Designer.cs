...
namespace Sowkoquiz.Infrastructure.Migrations
{
    ...
    [Migration("20240517222459_AddedPassThreshold")]
    partial class AddedPassThreshold
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sowkoquiz.Domain.ActiveQuizEntity.ActiveQuiz", b =>
                {
                    ...
                    b.OwnsMany("Sowkoquiz.Domain.ActiveQuizEntity.AnsweredQuestion", "AnsweredQuestions", b1 =>
                        {
                            b1.Property<int>("Id")
                                .HasColumnType("INTEGER");
                            ...
                            b1.HasKey("Id", "ActiveQuizId", "Letter");

                            b1.HasIndex("ActiveQuizId");
