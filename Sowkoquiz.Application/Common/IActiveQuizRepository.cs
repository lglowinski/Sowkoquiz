...
public interface IActiveQuizRepository
{
    ...
    public Task<bool> UpdateAsync(ActiveQuiz quiz, CancellationToken cancellationToken = default);
    ...
    Task<List<ActiveQuiz>> GetInactiveQuizzesAsync(int retentionTime, CancellationToken cancellationToken = default);
}